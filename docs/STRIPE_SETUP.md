...
### 2.3 Gworth Program (주당 1/2/3회 → 월 결제)
...
| `STRIPE_PRICE_MONTHLY_1X` | Gworth Program 주 1회 월 결제 Price ID |
| `STRIPE_PRICE_MONTHLY_2X` | Gworth Program 주 2회 월 결제 Price ID |
| `STRIPE_PRICE_MONTHLY_3X` | Gworth Program 주 3회 월 결제 Price ID |
...
| Gworth Program 1x | 4회권 (한 달 유효) |
| Gworth Program 2x | 8회권 (한 달 유효) |
| Gworth Program 3x | 12회권 (한 달 유효) |
