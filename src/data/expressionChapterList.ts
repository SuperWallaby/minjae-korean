  ...
  sections: [
    ...
    },
    {
      ...
      chapters: [
        {
          id: "exp-060",
          slug: "softening-and-nuance",
          number: 1,
          title: "Softening & Nuance",
          description: "좀/조금, -거든요, -네요, -나 봐요",
          meta: { frames: 8, minutes: 6 },
        },
        {
          id: "exp-061",
          slug: "natural-fillers",
          number: 2,
          title: "Natural Fillers",
          description: "그…/그러니까, 음…, 사실(은), 뭐랄까",
          meta: { frames: 7, minutes: 5 },
        },
        {
          id: "exp-062",
          slug: "agree-and-pushback",
          number: 3,
          title: "Agree & Push Back",
          description: "맞아요/그렇죠 + 근데/하지만, -긴 한데요",
          meta: { frames: 8, minutes: 6 },
        },
        {
          id: "exp-063",
          slug: "giving-reasons-politely",
          number: 4,
          title: "Giving Reasons (Politely)",
          description: "-아/어서요, -거든요, -(으)니까요",
          meta: { frames: 8, minutes: 6 },
        },
        {
          id: "exp-064",
          slug: "plans-and-conditions",
          number: 5,
          title: "Plans & Conditions",
          description: "-(으)면, -면 좋겠어요, -아/어야 돼요",
          meta: { frames: 8, minutes: 6 },
        },
        {
          id: "exp-065",
          slug: "opinions-and-feelings",
          number: 6,
          title: "Opinions & Feelings",
          description: "-는 것 같아요, -더라고요, -잖아요",
          meta: { frames: 8, minutes: 6 },
        },
      ],
    },
